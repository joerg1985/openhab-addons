...
| decay    | Number:Dimensionless             | The decoy count in the last time frame |
...
Number:Dimensionless                 decoy    "Decoy count [%d %unit%]"   { channel="bluetooth:radoneye_rd200:adapter1:sensor1:decoy" }
```
